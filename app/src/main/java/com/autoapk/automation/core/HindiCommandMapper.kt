...
object HindiCommandMapper {
    ...
    private val translationRules: List<Pair<String, String>> = listOf(
        ...
        // === CAMERA (PHOTO / SELFIE) ===
        "photo khicho" to "take photo",
        "फोटो खींचो" to "take photo",
        "photo lo" to "take photo",
        "फोटो लो" to "take photo",
        "tasveer lo" to "take photo",
        "तस्वीर लो" to "take photo",
        "tasveer khicho" to "take photo",
        "तस्वीर खींचो" to "take photo",
        "picture khicho" to "take photo",
        "पिक्चर खींचो" to "take photo",
        "picture lo" to "take photo",
        "पिक्चर लो" to "take photo",
        "selfie lo" to "take selfie",
        "सेल्फी लो" to "take selfie",
        "selfie khicho" to "take selfie",
        "सेल्फी खींचो" to "take selfie",
        "selfie le lo" to "take selfie",
        "meri selfie lo" to "take selfie",
        "मेरी सेल्फी लो" to "take selfie",
        "meri photo lo" to "take selfie",
        "मेरी फोटो लो" to "take selfie",
        "apni photo lo" to "take selfie",
        "अपनी फोटो लो" to "take selfie",
        ...
        // === RAPIDO RIDE BOOKING ===
        "रैपिडो खोलो" to "open rapido",
        "rapido kholo" to "open rapido",
        "रैपिडो बुक करो" to "book rapido",
        "rapido book karo" to "book rapido",
        "रैपिडो चलाओ" to "book rapido",
        "rapido chalao" to "book rapido",
        "रैपिडो से चलो" to "book rapido",
        "rapido se chalo" to "book rapido",
        "राइड बुक करो" to "book rapido",
        "ride book karo" to "book rapido",
        "पिन बताओ" to "rapido pin",
        "pin batao" to "rapido pin",
        "मेरा पिन क्या है" to "what is my pin",
        "mera pin kya hai" to "what is my pin",
        "पिन दिखाओ" to "rapido pin",
        "pin dikhao" to "rapido pin",
        "रैपिडो पिन" to "rapido pin",
        "राइड कैंसल करो" to "cancel ride",
        "ride cancel karo" to "cancel ride",
        "रैपिडो कैंसल करो" to "cancel rapido",
        "rapido cancel karo" to "cancel rapido",
        "बुकिंग कैंसल करो" to "cancel ride",
        "booking cancel karo" to "cancel ride",
        ...
        "dekhna chalu karo" to "start watching",
        "देखना चालू करो" to "start watching",
        "dekhna shuru karo" to "start watching",
        "देखना शुरू करो" to "start watching",
        "watching chalu karo" to "start watching",
        "nazar rakho" to "start watching",
        "नज़र रखो" to "start watching",
        "नजर रखो" to "start watching",
        ...
        "dekhna band karo" to "stop watching",
        "देखना बंद करो" to "stop watching",
        "dekhna bund karo" to "stop watching",
        "watching band karo" to "stop watching",
        "mat dekho" to "stop watching",
        "मत देखो" to "stop watching",
        "nazar hatao" to "stop watching",
        "नज़र हटाओ" to "stop watching",
        "नजर हटाओ" to "stop watching",
